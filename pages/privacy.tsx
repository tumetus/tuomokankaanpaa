...
export default function Privacy() {
  return (
    <Layout>
      ...
      <p>
        At tuomokankaanpaa.com, accessible from tuomokankaanpaa.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        tuomokankaanpaa.com and how we use it.
      </p>
      ...
      <p>
        tuomokankaanpaa.com follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, tuomokankaanpaa.com uses 'cookies'. These
      ...
      <p>
        ...
        advertising partners of tuomokankaanpaa.com.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on tuomokankaanpaa.com, which are
      ...
      <p>
        Note that tuomokankaanpaa.com has no access to or control over these
      ...
      <p>
        tuomokankaanpaa.com's Privacy Policy does not apply to other advertisers
      ...
      <p>
        tuomokankaanpaa.com does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in tuomokankaanpaa.com. This policy is not
